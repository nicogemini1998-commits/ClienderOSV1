...
export default function CompanyCard({ lead, onClick, onStatusChange, onPhoneRevealed }) {
  ...
  return (
    <article
      ...
      className="bg-gradient-to-br from-surface-card to-surface border border-surface-border/60 rounded-xl cursor-pointer animate-fade-in group overflow-hidden shadow-[0_4px_12px_-2px_rgba(0,0,0,0.2)] hover:shadow-[0_8px_20px_-4px_rgba(0,0,0,0.3)] hover:border-accent/40 transition-all duration-200 p-0"
    >
      {/* Accent top stripe */}
      ...
      <div className="p-4">
        ...
        <div className="flex items-start justify-between gap-3 mb-2">
          <div className="min-w-0 flex-1">
            <h3 className="text-white font-bold text-base leading-tight truncate group-hover:text-accent transition-colors duration-200">
              {company.name}
            </h3>
