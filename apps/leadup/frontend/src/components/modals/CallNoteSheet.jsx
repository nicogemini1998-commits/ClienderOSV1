...
export default function CallNoteSheet({
  ...
  const presets = useMemo(() => getCallbackPresets(), [])
          ...
          <div className="p-5 space-y-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="font-semibold text-white truncate text-sm">{companyName}</p>
              </div>
              <div className="flex items-center gap-2">
                <span className={`badge border text-[11px] font-semibold px-2.5 py-1 ${STATUS_COLORS[newStatus] || STATUS_COLORS.pending}`}>
